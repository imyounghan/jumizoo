...
/**
 * please see https://github.com/mongodb/mongo-java-driver
...
public final class ObjectId implements Comparable<ObjectId>, Serializable {
    ...
    public ObjectId(final byte[] bytes) {
        this(ByteBuffer.wrap(Verify.verifyNotNull(bytes)));
    }
    ...
    public ObjectId(final ByteBuffer buffer) {
        Verify.verifyNotNull(buffer);
        Verify.verify(buffer.remaining() >= 12,"buffer.remaining() >=12");
